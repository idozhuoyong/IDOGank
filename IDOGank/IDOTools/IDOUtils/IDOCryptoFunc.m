...
+ (NSString *)base64StringFromText:(NSString *)text
{
    ...
    return [self base64StringFromText:text withKey:key];
}
...
{
    if (text && ![text isEqualToString:LocalStr_None] && key && ![key isEqualToString:LocalStr_None]) {
...
{
    NSString *key = [[NSBundle mainBundle] bundleIdentifier];
    return [self textFromBase64String:base64 withKey:key];
}
...
{
    if (base64 && ![base64 isEqualToString:LocalStr_None] && key && ![key isEqualToString:LocalStr_None]) {

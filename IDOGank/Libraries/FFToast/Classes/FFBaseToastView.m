        ...
        [UIView animateWithDuration:0.5f
             ...
             usingSpringWithDamping:0.7f
              initialSpringVelocity:0.5f
                         ...
                         animations:^{
                             self.frame = self.toastViewFrame;
                             self.alpha = self.toastAlpha;
        ...
        @synchronized (toastArray) {
            ...
            if (self.dismissToastAnimated == YES && _toastPosition != FFToastPositionBottom && _toastPosition != FFToastPositionBottomWithFillet) {
                ...
                [UIView animateWithDuration:0.2f
                                 animations:^{
                                     toast.alpha = 0.f;
                                     self.frame = CGRectMake(self.toastViewFrame.origin.x, -(self.toastViewFrame.size.height + tempStatusBarHeight), self.toastViewFrame.size.width, self.toastViewFrame.size.height);
                                 } completion:^(BOOL finished) {
